        ...
        <section className={classes.features_container}>
          <article className={classes.feature_article}>
            ...
            <p className={classes.feature_text}>
              Sabe quando seu cliente liga e diz que esqueceu do horário
              agendado com você? Pois é, com o portal{" "}
          ...
          <article className={classes.feature_article}>
            ...
            <p className={classes.feature_text}>
              Com o portal{" "}
              <span className={classes.meu_negocio_text}>Meu Negocyo</span> você
              nunca mais vai sentir aquela sensação de desorganização em relação
              a fotos do antes e depois de seus clientes. Nós armazenamos esse
              item extremamente importante para você com total segurança e
              praticidade.
            </p>
          </article>
          <article className={classes.feature_article}>
            ...
            <p className={classes.feature_text}>
              ...
              pendências financeiras, fotos do antes e depois, anamneses,
              agenda, mensagens, etc. Com o portal{" "}
          ...
          <article className={classes.feature_article}>
            ...
            <p className={classes.feature_text}>
              ...
              quanto, onde e como cada cliente gastou no seus serviços e
              produtos.
            </p>
          </article>
          <article className={classes.feature_article}>
            ...
            <p className={classes.feature_text}>
              Crie a sua conta e tenha uma ferramenta poderosa que irá te ajudar
              a saber o valor de comissões a serem pagas a seus colaboradores,
