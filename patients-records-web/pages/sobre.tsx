      ...
      <section className={classes.presentation_container}>
        <div className={classes.presentation_container_left}>
          <p className={classes.presentation_title}>
            O portal{" "}
            <span className={classes.meu_negocio_text}>Meu Negócio</span> se
      ...
      <section className={classes.features_container}>
        <article className={classes.feature_article}>
          ...
          <p className={classes.feature_text}>
            ...
            <span className={classes.meu_negocio_text}>Meu Negócio</span> você
        ...
        <article className={classes.feature_article}>
          ...
          <p className={classes.feature_text}>
            ...
            <span className={classes.meu_negocio_text}>Meu Negócio</span> sua
        ...
        <article className={classes.feature_article}>
          ...
          <p className={classes.feature_text}>
            O portal{" "}
            <span className={classes.meu_negocio_text}>Meu Negócio</span> sabe
        ...
        <article className={classes.feature_article}>
          ...
          <p className={classes.feature_text}>
            ...
            <span className={classes.meu_negocio_text}>Meu Negócio</span>.
          </p>
        </article>
      </section>
